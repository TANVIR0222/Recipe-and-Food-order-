  ...
  return (
    <div>
      <div className="grid gap-8 md:grid-cols-2 text-left mx-4 items-center justify-center">
        ...
        <div className="">
          <h1 className="text-xl md:text-5xl leading-9 md:leading-relaxed ">Pineapple + Smoked Jackfruit Pizza</h1>
          <p className="leading-6 truncate text-wrap md:leading-7 my-2 text-left">
            ...
            vesitbulum euismod morbi ullamcorper return.Orci <br /> cras in phasellus
            ultricies{" "}
          </p>
          <Button className="my-5" color="light">View Recipe</Button>
